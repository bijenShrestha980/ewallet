!(function () {
  ...
  var a,
    ...
    s,
    d,
    l = document.querySelector(".navbar-menu").innerHTML,
    i = 6,
    r = "en",
  ...
  function g() {
    ...
    !a ||
      ...
      ((document.querySelector(".navbar-menu").innerHTML = l),
  ...
  function h() {
    ...
    e < 1025 && 767 < e
      ...
      document
        ...
        .forEach(function (e) {
          e.addEventListener("click", f.bind(this), !1),
            e.addEventListener("mouseover", f.bind(this), !1);
        });
  }
  function f(e) {
    if (e.target && e.target.matches("a.nav-link span"))
      if (0 == b(e.target.parentElement.nextElementSibling))
        ...
        1 == b(e.target.parentElement.nextElementSibling) &&
    ...
    if (e.target && e.target.matches("a.nav-link"))
      if (0 == b(e.target.nextElementSibling))
  ...
  function k(e) {
    if (e == e) {
      ...
      switch (e["data-layout-mode"]) {
        case "light":
          B("data-layout-mode", "light"),
            document.documentElement.setAttribute("data-layout-mode", "light"),
            sessionStorage.setItem("data-layout-mode", "light");
          break;
        case "dark":
          B("data-layout-mode", "dark"),
      ...
      switch (e["data-layout-position"]) {
        case "fixed":
          ...
          break;
        case "scrollable":
          B("data-layout-position", "scrollable"),
  ...
  sessionStorage.getItem("defaultAttribute")
    ? (((a = {})["data-layout"] = sessionStorage.getItem("data-layout")),
      ...
      k(a))
    : ((s = document.documentElement.attributes),
      (a = {}),
    ...
    (e = document.getElementById("search-options")).addEventListener(
      "focus",
      function () {
        0 < e.value.length
    ...
    (s = document.querySelector('[data-toggle="fullscreen"]')) &&
    ...
    (s = document.querySelectorAll(".light-dark-mode")) &&
      s.length &&
      s[0].addEventListener("click", function (e) {
        n.hasAttribute("data-layout-mode") &&
        "dark" == n.getAttribute("data-layout-mode")
          ? z("data-layout-mode", "light", "layout-mode-light", n)
          : z("data-layout-mode", "dark", "layout-mode-dark", n);
      }),
    v(),
    S(),
    y(),
